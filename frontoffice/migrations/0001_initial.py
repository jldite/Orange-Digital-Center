    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backoffice_registration', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='frontoffice_registration', to='events.registration', verbose_name='Inscription Backoffice')),
